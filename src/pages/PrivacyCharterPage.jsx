    ...
    <div className="min-h-screen bg-white text-ink flex flex-col font-body selection:bg-rose-light">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <section className="text-center max-w-3xl mx-auto mb-14">
          <span className="text-xs font-heading font-bold uppercase tracking-wider text-peach-dark block mb-3">
        ...
        <nav className="mb-14 p-2 bg-stone-50 rounded-card border border-stone-200/80 flex flex-wrap justify-center gap-2 text-xs font-heading font-bold">
          <a href="#privacy" className="px-4 py-2 rounded-xl bg-white hover:bg-rose-light/40 text-ink shadow-soft transition-all">
            Privacy Charter
          </a>
          <a href="#clinical-standards" className="px-4 py-2 rounded-xl bg-white hover:bg-rose-light/40 text-ink shadow-soft transition-all">
            Clinical Standards
          </a>
          <a href="#local-guarantee" className="px-4 py-2 rounded-xl bg-white hover:bg-rose-light/40 text-ink shadow-soft transition-all">
            Local Storage Guarantee
          </a>
          <a href="#zero-paywalls" className="px-4 py-2 rounded-xl bg-white hover:bg-rose-light/40 text-ink shadow-soft transition-all">
            100% Free Forever
          </a>
        </nav>

        {/* Section 1: Privacy Charter */}
        <section id="privacy" className="scroll-mt-28 mb-16 bg-white border border-stone-200 rounded-card p-8 sm:p-10 shadow-soft">
        ...
        <section id="clinical-standards" className="scroll-mt-28 mb-16 bg-sage-light/25 border border-sage-light/60 rounded-card p-8 sm:p-10 shadow-soft">
        ...
        <section id="local-guarantee" className="scroll-mt-28 mb-16 bg-rose-light/25 border border-rose-light/60 rounded-card p-8 sm:p-10 shadow-soft">
        ...
        <section id="zero-paywalls" className="scroll-mt-28 mb-16 bg-white border border-stone-200 rounded-card p-8 sm:p-10 shadow-soft">
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-3">
